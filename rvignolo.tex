...
\filadosentres{}{Desarrollo e incorporación del método de las características como aproximación para la resolución de la ecuación de transporte al código neutrónico milonga (algoritmos de \emph{ray tracing} y \emph{solver} de potencias no lineal).}
